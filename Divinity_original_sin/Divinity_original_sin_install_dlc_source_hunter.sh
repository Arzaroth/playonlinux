#!/bin/bash
# Date : (2014-10-08 22-21)
# Last revision : (2014-10-09 00-12)
...
TITLE="$(eval_gettext 'Divinity: Original Sin (GoG release) DLC Source Hunter')"
...
install_file "setup_divinity_original_sin_dlc_source_hunter_2.5.0.1.exe" "8384128" "7430dcfef42a09b672a874386f6db449"
