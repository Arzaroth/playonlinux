...
TITLE="$(eval_gettext 'Divinity: Original Sin (GoG release) 1.0.169 to 1.0.177 patch')"
...
install_file "patch_divinity_original_sin_2.11.0.21.exe" "1152392" "0d8efeede482311e6e259030e53c51cf"
