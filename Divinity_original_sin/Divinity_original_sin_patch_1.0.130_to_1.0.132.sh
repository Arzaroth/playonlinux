...
TITLE="$(eval_gettext 'Divinity: Original Sin (GoG release) 1.0.130 to 1.0.132 patch')"
...
install_file "patch_divinity_original_sin_hotfix_2.9.0.17.exe" "3800232" "a70cc534573bbf74745d27e122c1090f"
