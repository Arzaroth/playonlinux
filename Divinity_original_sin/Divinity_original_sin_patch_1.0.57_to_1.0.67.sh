#!/bin/bash
# Date : (2014-10-08 22-19)
# Last revision : (2014-10-08 22-19)
...
TITLE="$(eval_gettext 'Divinity: Original Sin (GoG release) 1.0.57 to 1.0.67 patch')"
...
install_file "patch_divinity_original_sin_2.4.0.10.exe" "4873952" "ad1220260e5877e5eea719c25c10da75"
