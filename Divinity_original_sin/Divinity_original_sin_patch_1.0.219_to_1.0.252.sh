#!/bin/bash
# Date : (2015-03-24 01-04)
# Last revision : (2015-03-24 01-04)
# Wine version used : 1.7.34-CSMT-cf92569
...
TITLE="$(eval_gettext 'Divinity: Original Sin (GoG release) 1.0.219 to 1.0.252 patch')"
ORIG_TITLE="$(eval_gettext 'Divinity: Original Sin (GoG release)')"
PREFIX="DivinityOriginalSin_gog"
WORKING_WINE_VERSION="1.7.34-CSMT-cf92569"
...
install_file "patch_divinity_original_sin_2.14.0.25.exe" "159697464" "2c1b7c04442fb1f77904e51ced566d69"
