...
# Last revision : (2014-10-08 22-21)
...
TITLE="$(eval_gettext 'Divinity: Original Sin (GoG release) 1.0.57 to 1.0.74 patch')"
...
install_file "patch_divinity_original_sin_2.5.0.11.exe" "346960168" "214bf8d3ccc9a615551cbed16d66a125"
