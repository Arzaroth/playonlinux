...
# Last revision : (2014-10-08 23-50)
...
TITLE="$(eval_gettext 'Divinity: Original Sin (GoG release) 1.0.130 to 1.0.169 patch')"
...
install_file "patch_divinity_original_sin_2.10.0.19.exe" "315435576" "fe80e250ffaf441e4b6f6f8247effbc6"
