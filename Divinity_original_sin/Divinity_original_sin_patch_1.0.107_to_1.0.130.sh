...
TITLE="$(eval_gettext 'Divinity: Original Sin (GoG release) 1.0.107 to 1.0.130 patch')"
...
install_file "patch_divinity_original_sin_2.9.0.16.exe" "160137512" "1fe0cdc24e4a021eaf94005f58a1f7dc"
